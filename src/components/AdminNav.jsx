    ...
    <div className="admin-nav-out">
      <nav className="admin-nav">
        ...
        <span className="sp3">
          ...
          <button disabled onClick={() => navigate('/admin/categories')}>
            Category
          </button>
        </span>
        <span className="sp4">
          <img src="/design-images/AdminNav sitting icon.svg" alt="icon" />
          <button disabled onClick={() => navigate('/admin/settings')}>Settings</button>
        </span>
        <span className="sp5">
          <img src="/design-images/AdminNav admin icon.svg" alt="icon" />
          <button disabled onClick={() => navigate('/admin/admins')}>Admins</button>
        </span>
